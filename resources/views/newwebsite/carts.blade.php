                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="bg-danger"> <a href="#" class="delete btn btn-danger btn-sm"
                                ...
                                data-target="#deleteModal"><i class="fa fa-trash"></i></a></button>
        ...
        <div class="card-deck">
            @foreach ($orders as $order)
                <div class="col-4-lg">
                    ...
                    <div class="card">
                        <img src="{{ asset('public/' . $order->cart->productColorSize->image) }}" class="card-img-top"
                            alt="{{$order->cart->productColorSize->image}}">
                        <div class="card-body">
                            <h5 class="card-title">{{ $order->color }}</h5>
                            <p class="card-text">{{ $order->size }}</p>
                            ...
                            <p class="card-text">is_approve: {{ $order->is_approve }}</p>
